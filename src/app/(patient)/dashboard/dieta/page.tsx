    ...
    return (
      <div className="min-h-screen bg-[#f5f0eb]">
        ...
        <main className="max-w-3xl mx-auto px-4 py-12 text-center space-y-4">
          ...
          <h1 className="text-xl font-bold text-[#13244f]">Minha Dieta</h1>
          <p className="text-gray-500 text-sm">Este conteúdo está disponível no plano anual ou como compra avulsa.</p>
  ...
  return (
    <div className="min-h-screen bg-[#f5f0eb]">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-5">
        <div>
          <p className="text-xs font-bold tracking-widest text-[#13244f]/50 uppercase mb-1">Sua alimentação</p>
          <h1 className="text-2xl font-bold text-[#13244f]">Minha Dieta</h1>
        </div>
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 text-center text-gray-400 text-sm">
          Conteúdo da Dieta de Reversão — em breve.
        </div>
      </main>
    </div>
  )
