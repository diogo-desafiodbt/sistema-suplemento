    ...
    <div className="min-h-screen bg-[#f5f0eb] flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-lg space-y-6">
          <div className="text-center space-y-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm mt-2 leading-relaxed">
                Seu pedido foi confirmado e já está sendo preparado. Avisaremos
                você por email quando houver novidades sobre o envio.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-5">
            ...
            {[
              ...
              <div key={item.title} className="flex gap-4">
                <div className="flex flex-col items-center">
                  ...
                  >
                    {item.done ? (
                      ...
                      <span className="text-xs font-bold text-[#13244f]">
                        {i + 1}
                      </span>
                    )}
                  </div>
                ...
                <div className="pb-4">
                  <p
                    className={`text-xs font-semibold mb-0.5 ${item.done ? 'text-[#13244f]' : 'text-gray-400'}`}
                  >
                    {item.status}
                  </p>
          ...
          <button
            type="button"
            onClick={() => router.push('/suplementos/dashboard')}
