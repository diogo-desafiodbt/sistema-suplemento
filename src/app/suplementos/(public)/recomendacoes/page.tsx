...
import imgLinhaSuplementos from '@/../public/linha-suplementos.png'
...
export default function RecomendacoesPage() {
  ...
  useEffect(() => {
    ...
    async function loadFromSessionAndEnrichWithPrices() {
      try {
        ...
        if (!cancelled) router.push('/suplementos/quiz')
      } finally {
  ...
  function handleContinue() {
    ...
    router.push('/suplementos/checkout')
  }
