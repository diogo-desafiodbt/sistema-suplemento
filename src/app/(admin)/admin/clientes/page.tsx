...
export default async function AdminClientesPage({
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <form method="GET" action="/admin/clientes" className="mb-6 flex gap-3">
          <input
            type="text"
            name="q"
            defaultValue={q}
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100">
                <th className="text-left px-5 py-3.5 text-xs font-bold tracking-widest text-[#13244f]/50 uppercase">Cliente</th>
                <th className="text-left px-5 py-3.5 text-xs font-bold tracking-widest text-[#13244f]/50 uppercase">Código</th>
                <th className="text-left px-5 py-3.5 text-xs font-bold tracking-widest text-[#13244f]/50 uppercase">Tier RFM</th>
